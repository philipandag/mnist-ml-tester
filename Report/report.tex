...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../Saves/KerasCNNv2/KerasCNNv2_mnist_784_ep32_acc.png}
    \caption{Wykres dokładności w zależności od epoki}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../Saves/KerasCNNv2/KerasCNNv2_mnist_784_ep32_loss.png}
    \caption{Wykres wartości funkcji straty w zależności od epoki}
\end{figure}
